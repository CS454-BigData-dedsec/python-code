...
<jsp:useBean id="cla" class="model.ChampionListBean" scope="page"/>
...
<c:if test="${fn:length(cla.champList) == 0 }" >
...
<br><br>
<table align="center">
<c:forEach items="${cla.champList}" var="champs" varStatus="theCount">

        <a href=""><div class="col-sm-3 col-md-2"><p><img src="${champs.image}"
        class="img-rounded"></p></div></a>
