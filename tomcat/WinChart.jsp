    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Champion', 'Popularity', 'Win', 'Loss'],
          <c:forEach items="${cl.champList}" var="champs">
          <c:set var="message" value="${champs.name}"/>
          ['<c:out value="${message}"/>',${champs.numberOfGames},${champs.wins},${champs.loses}],
          </c:forEach>
          ['',0 ,0 ,0]
        ]);
        ...
        var options = {
          chart: {
            title: 'Champions Win/Loss/Popularity',
            subtitle: '',
          },
...
<body background="background_4.jpg" bgproperties="fixed">
...
<form action="/PullData" method="get" >
 <ul>
  ...
  <li><a href="/DisplayData.jsp"><span>All Champions</span></a></li>
...
<table class="bordered">
    <div id="barchart_material" style="width: 500px; height: 3500px;"></div>
</table>
